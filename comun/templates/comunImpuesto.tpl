		...
		<div class="span-20" style="background-color:#fafafa; padding-top:5px; padding-bottom:5px;" >
			...
			<div class="span-4" >
				<select name="campo" id="campo" size="0" style="width:150px;  padding:3px 0 3px 0; ">
					<option value="{campoOrd}" >{id}</option>
					<option value="{IdCampo}" >{desde}</option>
				</select>
			</div>
			...
			<form id="ftabla" name="ftabla" method="post" action="{phpFile}.php" >
				...
				<div id="divTabla"  class="span-9 last"  style="border-left:10px solid #eeeeee; padding-left:15px" >
					<div class="span-3 datos">
						<label id="desde">{desde}<br/><input class="text sombra span-2" id="1desde" name="desde" type="text" value="{_desde}" /></label>
					</div>
                                      
                    <div class="span-3 datos">
						<label id="hasta">{hasta}<br/><input class="text sombra span-2" id="1hasta" name="hasta" type="text" value="{_hasta}" /></label>
					</div>
                    
                    <div class="span-3 datos last">
						<label id="factor">{factor}<br/><input class="text sombra span-2" id="1factor" name="factor" type="text" value="{_factor}" /></label>
					</div>
                    
                    <div class="span-3 datos last">
						<label id="rebaja">{rebaja}<br/><input class="text sombra span-2" id="1rebaja" name="rebaja" type="text" value="{_rebaja}" /></label>
					</div>
