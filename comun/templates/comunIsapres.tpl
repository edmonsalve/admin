		...
		<div id="divCont" class="span-20" >	
			...
			<form id="ftabla" name="ftabla" method="post" action="{phpFile}.php" >
				...
				<div id="divTabla"  class="span-9 last"  style="border-left:10px solid #eeeeee; padding-left:15px" >
                    ...
                    <div class="span-4 datos">
						<label id="cuenta">{cuenta}<br/><input class="text sombra span-4" id="0cuenta" name="cuenta" type="text" value="{_cuenta}" /></label>
					</div>
                    
                    <div class="span-4 datos">
						<label id="rut">{rut}<br/><input class="text sombra span-3" id="0rut" name="rut" type="text" value="{_rut}" /></label>
					</div>
