<?php 
	...
	$dBase  	  		= DB_COMUN;
    $tablaDB	  		= "comun_tabIsapre";
	$IdCampo	  		= "id";
	$phpFile 			= "comunIsapres";
	$orderBy			= "entidad";
	...
	switch ($operacion) {
		...
		case 'Delete': 	$locationFile = $_SERVER['SCRIPT_NAME'];
						$errorMensaje = "ERROR_borrarTabIsapres";
	...
	$contenido=new plantilla("comunIsapres");
	$contenido->asigna_variables(
            ...
            "H2Titulo"		      => $sistema_txt->GetDefinition('H2Isapres'),
            "TInforme"		      => $sistema_txt->GetDefinition('TINFIsapres'),
