<?php
    ...
    */
    ...
    $pdf = new TCPDF($orientacion, 'mm','A4');
    ...
    /*
    echo "<br><br>**** VARIABLES DE INFORME ****</br>";
    ...
    */
    ...
    while ($row = mysqli_fetch_array($salida)) {
        ...
        foreach($columnnasL1 as $linea  => $valor) {
                ...
                if ($negrita) {  $pdf->SetFont('helvetica','B',$fontSize); } else { $pdf->SetFont('helvetica','',$fontSize); }
