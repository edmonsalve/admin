<?php
	...
	/** Valor viene definido grillaLee3
	...
	*/
	...
	if (isset($_SESSION['pag'])) { 
		$pagAct	       = $_SESSION['pag']; 
		$RegInicial    = (($_SESSION['pag'] - 1) * $lineasPorPagina); 
	...
	$paginacionHTML .= '</div>';
	/*	echo "<br>grillaPaginacion3.php - inicio <br> $consulta ---  $lineasPorPagina<br>"; */
?>
