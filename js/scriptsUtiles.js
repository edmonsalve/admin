...
/* ---------------------------- funciones de busqueda en ventana emergente ----------------------------------------------------------- */
function buscaEmergente(RUTA_ABSOLUTA,db,tabla,campoOrigen,criterios,titulosCrit,camposGrilla,camposAncho) { 
        url = RUTA_ABSOLUTA+'includes/buscar.php?db='+db+'&tabla='+tabla+'&campoOrigen='+campoOrigen+'&criterios='+criterios+'&titulosCrit='+titulosCrit+'&camposGrilla='+camposGrilla+'&camposAncho='+camposAncho;
    	/* par = 'width=800, height=450, resizable=no, status=no, location=NO, menubar=NO, titlebar=no, scrollbars=no'; */
        par = 'width=800, height=450, menubar=YES, titlebar=YES';
    	window.open(url,'Busqueda');
    }