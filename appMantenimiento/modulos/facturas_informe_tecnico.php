...
$idInformeTecnico = $_GET['id'] ?? '';
if (!ctype_digit((string) $idInformeTecnico)) {
...
$consulta = $pdo->prepare('SELECT archivo, mimeTipo FROM adm_facturas_informes_tecnicos WHERE idInformeTecnico = ?');
$consulta->execute(array((int) $idInformeTecnico));
